...
export class GameComponent implements OnInit {
  ...
  randomCards() {//enter cards from server double
    ...
    while (this.listRandomCardsFromServer.length > 0) {
      ...
      this.listRandomCardsFix[i++] ={key:this.listRandomCardsFromServer[this.rand]["key"],value:this.listRandomCardsFromServer[this.rand]["value"]};
      this.listRandomCardsFromServer.splice(this.rand, 1);
    }
    console.log(this.listRandomCardsFix);
  }
